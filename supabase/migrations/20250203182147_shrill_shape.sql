/*
  ...
  1. Changes
    ...
    - Create transactions table with increased numeric precision
    - Create indexes
    - Enable RLS
    - Create policies
...
-- Create transactions table with proper references and increased numeric precision
CREATE TABLE transactions (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id uuid REFERENCES profiles(id) NOT NULL,
  amount numeric(15,2) NOT NULL CHECK (amount > 0), -- Increased precision to handle larger amounts
